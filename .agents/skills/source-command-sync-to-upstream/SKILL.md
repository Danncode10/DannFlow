...
Use this when:
- You improved a `.Codex/commands/` or `.codex/commands/` file that would benefit every DannFlow project
...
```
.Codex/commands/        (top-level .md files only — exclude Ruflo subdirectories)
.Codex/agents/
.Codex/skills/
.codex/commands/
.codex/context/
...
#   Status   Class              Path
─────────────────────────────────────────────────────────────────
1   Added    🟢 UPSTREAM        .Codex/commands/update-masterplan.md
2   Added    🟢 UPSTREAM        .codex/commands/Codex-command.md
3   Modified 🟡 REVIEW NEEDED   .Codex/commands/commit.md
4   Modified 🔒 KEEP LOCAL      .Codex/commands/new-page.md
...
**If the user picks Option A and wants Codex to do it:**
